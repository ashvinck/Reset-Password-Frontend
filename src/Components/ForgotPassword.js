...
const ForgotPassword = () => {
    ...
    const ForgotPassword = (user) => {
        ...
        fetch(`${API}/auth/forgot-password`, {
            ...
            .then((data) => { toast.update(id, { render: data.message, type: (data.message.includes("Password reset mail has been sent successfully")) ? "success" : "error", isLoading: false, autoClose: 5000, }) })
            .catch((err) => {
                toast(err.message)
            })
