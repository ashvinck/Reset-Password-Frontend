...
export const Signup = () => {
    ...
    const createUser = (newUser) => {
        ...
        fetch(`${API}/auth/signup`, {
            ...
            .then(res => res.json())
            .then((data) => { toast.update(id, { render: data.message, type: (data.message === "Signup successful.Please login") ? "success" : "error", isLoading: false, autoClose: 5000, }) })
            .then(() => {
                setTimeout(() => {
                    navigate("/login")
                }, 6000)
        ...
        <div className='form-wrapper col'>
            ...
            <form onSubmit={formik.handleSubmit} className='form'>
                ...
                <div className="form-floating">
                    <input type="text" className="form-control" id="username" placeholder="Username" value={formik.values.username} onChange={formik.handleChange} onBlur={formik.handleBlur} />
